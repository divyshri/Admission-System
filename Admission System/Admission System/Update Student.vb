...
Public Class Update_Student
    ...
    Private Sub UpdateButton_Click(sender As System.Object, e As System.EventArgs) Handles UpdateButton.Click
        Dim str As String
        str = "UPDATE [Admission] SET [name] = '" & StdNameTextBox.Text & "' , [father] = '" & FatherNameTextBox.Text & "', [mother] = '" & _
    ...
    Private Sub Update_Student_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
